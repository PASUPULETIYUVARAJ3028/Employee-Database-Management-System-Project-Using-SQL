...
**DataBase Name**: Employee_DB_Management_System

I built an Employee Database Management System to simulate a real HR backend. It includes key tables such as departments, Employees, Performance_Reviews,Attendance, Projects, and Employee_Projects. In this project, I also created various database objects like views, stored procedures, triggers, CTAS and performed data analysis to gain insights from the data. This project gave me hands-on experience with real-world SQL practices.

![EDBMS](https://github.com/PASUPULETIYUVARAJ3028/Employee-Database-Management-System-Project-Using-SQL/blob/main/product-jpeg-500x500.webp)
